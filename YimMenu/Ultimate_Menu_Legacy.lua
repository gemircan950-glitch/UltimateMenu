...
local TAGET_BUILD <const> = "3751.0"
...
Yimura = CreditsMenu:add_tab("Emir777")
...
L7NEGDEV = CreditsMenu:add_tab("Kusay")
...
SILENTSALO = CreditsMenu:add_tab("ToastBrot150")
